...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../ip/xlnx/mmcm/mmcm.xci"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../hdl/rtl/uart_rx.v"]"\
 "[file normalize "$origin_dir/../hdl/rtl/uart_tx.v"]"\
 "[file normalize "$origin_dir/../../memory_components/hdl/rtl/fifo_sync_sram_based.sv"]"\
 "[file normalize "$origin_dir/../../memory_components/hdl/rtl/sram_tp_true.sv"]"\
...
set _xil_proj_name_ "arty_uart_rx_tx"
...
set script_file "arty_uart_rx_tx.tcl"
...
set file "$origin_dir/../../memory_components/hdl/rtl/fifo_sync_sram_based.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../../memory_components/hdl/rtl/sram_tp_true.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "uart_rx_tx_top" -objects $obj
